...
!!! note "Note"
    Documentation for this service is being migrated. See the new - [Look up debt without consent](4.%20Lookup%20debt%20without%20consent.md) section for updated documentation.
